...
{ .p_info = &g_transfer3_info, .activation_source = ELC_EVENT_IIC2_RXI, .auto_enable = false, .p_callback = NULL,
...
{ .p_info = &g_transfer2_info, .activation_source = ELC_EVENT_IIC2_TXI, .auto_enable = false, .p_callback = NULL,
