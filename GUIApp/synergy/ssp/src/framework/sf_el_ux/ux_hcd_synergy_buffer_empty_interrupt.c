...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    ux_hcd_synergy_buffer_empty_interrupt               PORTABLE C      */
/*                                                           5.6          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
...
/*******************************************************************************************************************//**
 * @brief  This function enable or disable the BEMP(Buffer Empty) interrupt for the pipe.
 *
...
VOID  ux_hcd_synergy_buffer_empty_interrupt(UX_HCD_SYNERGY *hcd_synergy, UX_SYNERGY_ED *ed, ULONG flag)
{
    ...
    synergy_bemp_register = ux_hcd_synergy_register_read(hcd_synergy, UX_SYNERGY_HC_BEMPENB);

    /* Enable or Disable ?  */
    if (flag == (ULONG)UX_SYNERGY_ENABLE)
    {
        /* Set the appropriate endpoint number.  */
        synergy_bemp_register |= (ULONG)(1UL << ed -> ux_synergy_pipe_index);
    }
    else
    {
    ...
    /* Wrie the BEMP register.  */
    ux_hcd_synergy_register_write(hcd_synergy, UX_SYNERGY_HC_BEMPENB, (USHORT)synergy_bemp_register);
