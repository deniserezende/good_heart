...
#define SSP_VERSION_STRING                  ("2.0.0")

/** Unique SSP version ID. */
#define SSP_VERSION_BUILD_STRING            ("Built with Renesas Synergy (TM) Software Package version 2.0.0+build.0d5941e5a1460560b6e6c024c22491ce82b0faf4")
