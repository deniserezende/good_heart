...
/**********************************************************************************************************************
 * File Name    : r_jpeg_decode_api.h
 * Description  : JPEG_DECODE interface layer API
 **********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup Interface_Library
 * @defgroup JPEG_DECODE_API JPEG Decode Interface
 * @brief Interface for JPEG decode functions.
 *
 * @section JPEG_DECODE_API_SUMMARY Summary
 * The JPEG DECODE interface provides JPEG decoder functionality.  It allows application to convert a JPEG image into
 ...
 *
 * JPEG DECODE Interface description: @ref HALJPEGDecodeInterface
 *
 * @{
 **********************************************************************************************************************/

#ifndef DRV_JPEG_DECODE_API_H
#define DRV_JPEG_DECODE_API_H
...
#define JPEG_DECODE_API_VERSION_MINOR (0U)
...
typedef enum e_jpeg_decode_data_format
{
    JPEG_DECODE_DATA_FORMAT_NORMAL = 0,                 ///< (1)(2)(3)(4)(5)(6)(7)(8) Normal byte order
...
{
    JPEG_DECODE_STATUS_FREE                  = 0x0,     ///< JPEG codec module is not yet open.
    JPEG_DECODE_STATUS_IDLE                  = 0x1,     ///< JPEG Codec module is open, and is not operational.
...
typedef struct st_jpeg_decode_cfg
{
    ...
    jpeg_decode_data_format_t   input_data_format;  ///< Input data stream byte order
    jpeg_decode_data_format_t   output_data_format; ///< Output data stream byte order
...
typedef struct st_jpeg_decode_api
{
     ...
     */
    ssp_err_t (* open)(jpeg_decode_ctrl_t        * const p_ctrl,
     ...
     */
    ssp_err_t (* outputBufferSet)(jpeg_decode_ctrl_t        * const p_ctrl,
                                  void                              * p_buffer,
     ...
     * @param[in]     buffer_size Size of the output buffer
     */
    ssp_err_t (* horizontalStrideSet)(jpeg_decode_ctrl_t    * const p_ctrl,
     ...
     */
    ssp_err_t (* inputBufferSet)(jpeg_decode_ctrl_t        * const p_ctrl,
                                 void                              * p_buffer,
                                 uint32_t                          buffer_size);
     ...
     */
    ssp_err_t (* linesDecodedGet)(jpeg_decode_ctrl_t  * const p_ctrl,
     ...
     */
    ssp_err_t (* imageSizeGet)(jpeg_decode_ctrl_t        * const p_ctrl,
