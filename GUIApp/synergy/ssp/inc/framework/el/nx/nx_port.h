...
/**************************************************************************/
/**                                                                       */
/** This file selects NetX port specific information based on the MCU     */
...
#define NX_INCLUDE_USER_DEFINE_FILE
        ...
        #include "../cm4_iar/nx/nx_port.h"
    #elif (__CORE__ == __ARM6M__)
        #include "../cm0plus_iar/nx/nx_port.h"
    #elif (__CORE__ == __ARM8M_BASELINE__)
        #include "../cm23_iar/nx/nx_port.h"
    #else
        #warning Unsupported Architecture
    #endif
#elif defined(__GNUC__)
    #if   __ARM_ARCH_7EM__
        #include "../cm4_gcc/nx/nx_port.h"
    #elif __ARM_ARCH_6M__
        #include "../cm0plus_gcc/nx/nx_port.h"
    #elif __ARM_ARCH_8M_BASE__
        #include "../cm23_gcc/nx/nx_port.h"
    #else
        #warning Unsupported Architecture
    #endif
#else
